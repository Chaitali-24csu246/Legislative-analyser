...
Processing might take some time so please be patient.
 ...
 Please note that HuggingFace will take more time than locally running as it has been deployed on free tier, please be patient while it analyses. Speed is much faster locally. If it takes too long please test manually instead. 
